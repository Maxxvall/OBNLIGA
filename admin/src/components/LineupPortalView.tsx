    ...
    <div className="portal-grid">
      <aside className="portal-card">
        ...
        <div className="portal-search">
          ...
          />
          <p className="portal-hint">Введите минимум 5 букв названия вашей команды.</p>
        </div>
            ...
            {matchesLoading
              ...
              : normalizedSearch
                ? normalizedSearch.length < MINIMUM_MATCH_LENGTH
                  ? 'Введите минимум 5 букв названия вашей команды.'
      ...
      <section className="portal-card">
        ...
        <ol className="portal-steps">
          <li>Введите минимум 5 букв названия вашей команды</li>
          <li>Нажмите на матч в открывшемся окне — выберите номера игроков и отметьте галочкой, кто сегодня присутствует.</li>
          <li>Менять состав можно до стартового свистка.</li>
        </ol>

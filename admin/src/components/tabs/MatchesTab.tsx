                  ...
                  <div className="group-stage-controls">
                    ...
                    {isCupCompetition && (
                      <p className="muted" style={{ fontSize: '0.85rem', marginTop: '0.5rem' }}>
                        🏆 {groupStageState.groupCount === 4 && groupStageState.groupSize === 3
                          ? 'Кубок 4×3: квалификация (2-е vs 3-и места) → 1/4 (1-е места + победители). Проигравшие 1/4 → Серебряный кубок.'
                          : groupStageState.groupCount === 2 && groupStageState.groupSize === 3
                          ? 'Кубок 2×3: после групп 4 лучших (1-е и 2-е места) → полуфинал → финал и 3 место.'
                          : groupStageState.groupCount === 2
                          ? 'Кубок: 8 команд в 1/4 финала (кросс-матчи). Проигравшие 1/4 → Серебряный кубок, победители → Золотой.'
                          : 'Кубок: после групп лучшие команды проходят в плей-офф.'}
                      </p>
                    )}
                  </div>
